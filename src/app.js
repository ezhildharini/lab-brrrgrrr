...
function renderIngredientsBoard() {
    ...
    if(state.Tomatoes){
      document.querySelector(".tomato").classList.remove("hide");
    }
    else {
      document.querySelector(".tomato").classList.add("hide");
    }

    if(state.Onions){
      document.querySelector(".onion").classList.remove("hide");
    }
    else {
      document.querySelector(".onion").classList.add("hide");
    }
